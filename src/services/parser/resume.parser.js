...
import textextractor from "./text_extractor.parser"
import resumeStructureInstance from "../ai.services/analyze_resume_structure"
...
class resumeParser {
    ...
    async parseResume(buffer, mimetype) {
        try {
            ...
            const aiStructuredData = await resumeStructureInstance(textdata.text)

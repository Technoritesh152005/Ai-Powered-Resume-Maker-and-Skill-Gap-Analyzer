// helps to keep all logs of everything in detail
const winston = require("winston")
// daily creates new log files
const DailyRotateFile = require('wisnton-daily-rotate-file')
const path = require('path')

// first create a format of how u want to store
const logFormat = winston.format.combine(
    // creates time format 
    wisnton.format.timestamp({format:'YYYY-MM-DD HH:mm:ss'}),
